...
import ite.kmitl.project.adapter.ProductAdminAdapter;
...
public class ShelveAdminFragment extends Fragment {

    private List<ProductItemDao> response_data;
    private ProductAdminAdapter dataAdapter;
    private RecyclerView mRecyclerView;

    private FirebaseDatabase firebaseDatabase;
    private DatabaseReference databaseReference;

    public ShelveAdminFragment() {
        super();
    }

    @SuppressWarnings("unused")
    public static ShelveAdminFragment newInstance() {
        ShelveAdminFragment fragment = new ShelveAdminFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_shelve_admin, container, false);
    ...
    private void initInstances(View rootView, Bundle savedInstanceState) {
        ...
        dataAdapter = new ProductAdminAdapter(response_data);
